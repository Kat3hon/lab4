...
void ParticleMenu::resetBackgroundParticle(int index) {
...
void ParticleMenu::resetCursorParticle(int index) {
    sf::Vector2f newPointPos;
    newPointPos.x = (float)(rand() % WIDTH);
    newPointPos.y = (float)(rand() % HEIGHT);
...
void ParticleMenu::draw(sf::RenderTarget & target, sf::RenderStates states) const {
